          ...
          <Formik>
            <Box ref={form} sx={{ mt: 2 }} component="form" onSubmit={handleSubmit}>
              <FormControl fullWidth className="form__input-wrapper">
                <FormLabel htmlFor="user-name">First and last name</FormLabel>
                <TextField
                  name="hoTen"
                  id="user-name"
                  variant="outlined"
              ...
              <FormControl fullWidth className="form__input-wrapper">
                <FormLabel htmlFor="user-acount">Account</FormLabel>
                <TextField
                  name="taiKhoan"
                  id="user-acount"
                  variant="outlined"
              ...
              <FormControl fullWidth className="form__input-wrapper">
                <FormLabel htmlFor="user-phoneNo">Phone number</FormLabel>
                <TextField
                  name="soDT"
                  id="user-phoneNo"
                  variant="outlined"
              ...
              <FormControl fullWidth className="form__input-wrapper">
                ...
                >
                  <MenuItem value="KhachHang">Client</MenuItem>
                  <MenuItem value="QuanTri">Administration</MenuItem>
                </Select>
