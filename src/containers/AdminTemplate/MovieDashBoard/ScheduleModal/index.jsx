          ...
          <Formik>
            <Box sx={{ mt: 2 }} component="form" onSubmit={handleSubmit}>
              <FormControl fullWidth className="form__input-wrapper">
                <FormLabel htmlFor="cine-system">Theater system</FormLabel>
                <Select
                  id="cine-system"
                  name="heThongRap"
              ...
              <FormControl fullWidth className="form__input-wrapper">
                <FormLabel htmlFor="cine-group">Cluster of theaters</FormLabel>
                <Select
                  id="cine-group"
                  name="cumRap"
              ...
              <FormControl fullWidth className="form__input-wrapper">
                <FormLabel htmlFor="movie-schedule">Showtime</FormLabel>
                <DateTimePicker
                  id="movie-schedule"
              ...
              <FormControl fullWidth className="form__input-wrapper">
                <FormLabel htmlFor="ticket-price">Fare</FormLabel>
                <TextField
                  type="number"
                  name="giaVe"
                  id="ticket-price"
              ...
              <SubmitButton sx={{ py: 1, mt: 2 }}>Create showtimes</SubmitButton>
            </Box>
          </Formik>
        </Box>
      </Modal>
