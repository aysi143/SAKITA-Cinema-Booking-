...
const initialState = {
  ...
  selectedSeats: [],
  modal: { open: false, title: "", children: [], buttonContent: "Accept", path: "" },
};
      ...
      if (!state.selectedSeats.length) {
        return {
          ...
          modal: {
            ...
            open: true,
            title: "Notify",
            children: ["Please choose at least one seat! You can buy up to 5 seats."],
            path: "",
          },
        };
      }
      ...
      return {
        ...
        modal: {
          ...
          children: [
            ...
            "Wish you have a happy movie watching experience at Finnkino Cinema",
          ],
          path: "/",
        },
      };
      ...
      if (selectedSeats.length === 5) {
        return {
          ...
          modal: {
            ...
            title: "Notify",
            children: [
              "You can only buy up to 5 seats.",
              "Please contact Sakita for better support.",
            ],
            path: "",
          },
        };
